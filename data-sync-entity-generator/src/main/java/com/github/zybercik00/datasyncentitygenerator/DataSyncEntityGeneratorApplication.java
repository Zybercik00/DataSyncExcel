...
public class DataSyncEntityGeneratorApplication {
    ...
    private final DataTransform transformData;
    private final DataSaver dataSaver;

    public DataSyncEntityGeneratorApplication(
    ...
    public void run() throws IOException, SQLException {
        ...
        List<JavaClass> classes = transformData.transformTablesToJavaSources(tables);
